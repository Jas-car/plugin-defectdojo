...
// token endpoints
type defectdojoRoleEntry struct {
...
func (r *defectdojoRoleEntry) toResponseData() map[string]interface{} {
...
func pathRole(b *defectdojoBackend) []*framework.Path {
...
func setRole(ctx context.Context, s logical.Storage, name string, roleEntry *defectdojoRoleEntry) error {
...
func (b *defectdojoBackend) getRole(ctx context.Context, s logical.Storage, name string) (*defectdojoRoleEntry, error) {
	if name == "" {
