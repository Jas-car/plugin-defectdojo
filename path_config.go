...
func pathConfig(b *defectdojoBackend) *framework.Path {
...
func (b *defectdojoBackend) pathConfigExistenceCheck(ctx context.Context, req *logical.Request, data *framework.FieldData) (bool, error) {
...
func (b *defectdojoBackend) pathConfigRead(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
...
func (b *defectdojoBackend) pathConfigWrite(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	config, err := getConfig(ctx, req.Storage)
	if err != nil {
		return nil, err
	}
...
func (b *defectdojoBackend) pathConfigDelete(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
...
func getConfig(ctx context.Context, s logical.Storage) (*defectdojoConfig, error) {
